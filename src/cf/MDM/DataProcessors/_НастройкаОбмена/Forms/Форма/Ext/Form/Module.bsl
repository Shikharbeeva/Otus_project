...
СтруктураЗначений.Вставить("КлючМаршрутизацииНоменклатура",КлючМаршрутизацииНоменклатура);   
...
Если Не СохДанные=Неопределено тогда
	...
	КлючМаршрутизацииНоменклатура=СохДанные.КлючМаршрутизацииНоменклатура; 
